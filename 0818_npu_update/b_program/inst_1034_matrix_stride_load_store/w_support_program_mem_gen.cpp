...
int main(int argc, char **argv)
{
    ...
    std::string instruction_32bit_array_string = ""; 
     ...
     instruction_vec[7] = (1 << 31) + (0 << 30) + (1 << 29) + (2 << 16) + (0 << 8) + 0x90;    // load, 1st, matrix
     instruction_vec[8] = (1 << 31) + (1 << 30) + (1 << 29) + (2 << 16) + (1 << 8) + 0x90;    // load, 2nd, matrix
     ...
     instruction_vec[12] = (1 << 31) + (1 << 29) + (2 << 16) + (1 << 8) + 0x98;    // save, matrix
