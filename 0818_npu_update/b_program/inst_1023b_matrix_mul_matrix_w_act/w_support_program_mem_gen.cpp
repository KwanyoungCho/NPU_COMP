...
int main(int argc, char **argv)
{
    ...
    std::string instruction_32bit_array_string = ""; 
     ...
     instruction_vec[6] = (1 << 31) + (2 << 16) + (3 << 8) + 0x88;    // matrix, set tile size, 2nd matrix, 2 x 3 
     instruction_vec[7] = (1 << 31) + (0 << 30) + 0x90;    // load, 1st, matrix
     instruction_vec[8] = (1 << 31) + (1 << 30) + 0x90;    // load, 2nd, matrix
     instruction_vec[9] = (2 << 30) + (1 << 29) + 0x42;    // matrix multiply, scalar, activation
     ...
     instruction_vec[15] = (2 << 16) + (2 << 8) + 0x88;    // matrix, set tile size, 2 x 2 
