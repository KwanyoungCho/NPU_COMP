...
int main(int argc, char **argv)
{
    ...
    std::string instruction_32bit_array_string = ""; 
     ...
     instruction_vec[3] = (0 << 31) + (3 << 16) + (2 << 8) + 0x88;    // matrix, set tile size, 1st matrix, 2 x 3 
     instruction_vec[4] = (1 << 31) + (0 << 30) + 0x90;    // load, 1st, matrix
     instruction_vec[5] = (0 << 30) + (1 << 29) + (3 << 8) + 0x42;    // matrix multiply, immediate, activation
     ...
     instruction_vec[8] = (1 << 31) + 0x98;    // save, matrix
     ...
     instruction_vec[11] = (3 << 16) + (2 << 8) + 0x88;    // matrix, set tile size, 2 x 3 
     instruction_vec[12] = (1 << 31) + (0 << 30) + 0x90;    // load, 1st, matrix
