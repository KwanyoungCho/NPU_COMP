...
int main(int argc, char **argv)
{
    ...
    std::string instruction_32bit_array_string = ""; 
     ...
     instruction_vec[9] = (0x2 << 30) + 0x0C;    // vector multiply-add, vector
     ...
     instruction_vec[12] = (0 << 31) + 0x98;    // save, vector
     ...
     instruction_vec[15] = (8 << 8) + 0x82;    // Global buffer length, Vector
     instruction_vec[16] = (0 << 31) + (0 << 30) + 0x90;    // load, 1st, vector
