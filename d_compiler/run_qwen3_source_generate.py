#!/usr/bin/env python3
"""Run/resume official Qwen3-4B prefill and greedy decode on source ver.08."""
import argparse
import json
import sys
...
from npu_compiler.qwen3_source import Qwen3SourceCompiler
...
def parse_args():
    ...
    parser.add_argument("--output", type=Path, default=BUILD / "qwen3_source_generate_hello")
