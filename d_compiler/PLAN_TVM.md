...
| **S5** | **링크** — 커널 인스턴스를 하나의 명령 스트림으로 연결 + C-model 실행 | ✅ (2026-08-28) 1-layer Llama가 C-model에서 llvm 빌드 대비 **cosine 0.999999, argmax 일치**. 층에 쓰이는 연산 13종 + matmul 4형태 전부 numpy와 일치 |
