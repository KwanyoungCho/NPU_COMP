...
| **S7** | **3-모델 end-to-end** (Gemma·Qwen3 nn.Module 추가) | ✅ (2026-09-01) **세 family 모두 전체 깊이 + 실제 체크포인트 + C-model에서 HF golden token 일치, NPU logits 기준 HF cosine golden 수준**: Llama 28층 358·0.9999927(기존 golden 0.9999881 상회)·15.3M word(−51.0%), Qwen3 36층 358·0.9999922·21.5M word, Gemma 35층 108·0.9997845·13.7M word |
